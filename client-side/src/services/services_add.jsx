...
const ServicesAdd = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('http://localhost/projects/services_insert.php', params)
            .then(function (response) {
                if (response.data['status'] === 'yes') {
                    alert("Data Successfully Inserted.");
    ...
    return (
        <div className="contact-form-container">
            <h1 className="form-title">Service Data Add Form</h1>
            <form className="contact-form" method="POST" encType="multipart/form-data" onSubmit={handleSubmit}>
                <div className="form-group">
                    <label htmlFor="image">Image:</label>
                    <input type="file" name="image" ref={txtimage} className="form-control" />
                ...
                <div className="form-group">
                    ...
                    <input type="text" name="details" placeholder="Enter service details" ref={txtdetails} className="form-control" />
                </div>
                <div className="form-group">
                    <input type="submit" name="submit" value="ADD" id="form-submit-button" />
                </div>

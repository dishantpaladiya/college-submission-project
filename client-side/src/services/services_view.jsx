...
const ServicesView = () => {
    ...
    const Fetchdata = () => {
        axios.get('http://localhost/projects/services_get.php').then(function (response) {
            setAlldata(response.data);
        })
    }
    ...
    const handleDelete = (e) => {
        ...
        axios.post('http://localhost/projects/services_delete.php', params).then(function (response) {
            if (response.data['status'] === 'yes') {
                alert("Delete Success.");
                Fetchdata();
            } else {
    ...
    return (
        <>
            ...
            <div className="add" style={{ marginTop: "20px" }}>
                <h3>If you want to edit data and check the result</h3>
                <Link to="/services">

...
import BannerListTable from './componets/BannerList/BannerListTable';
import MyDialog from './componets/BannerList/MyDialog';
...
const BannerList = () => {
    ...
    const fetchGetApi = async () => {
        const response = await axios.get('http://localhost/projects/banner_view.php')
        ...
        <>
            <Box sx={{ display: 'flex' }}>
                ...
                >
                    ...
                    <BannerListTable dataArray={data} fetchApi={fetchGetApi} />

...
import UserListTable from './componets/ProductList/ProductListTable';
import MyDialog from './componets/ProductList/MyDialog';
...
const ProductList = () => {
    ...
    const fetchGetApi = async () => {
        const response = await axios.get('http://localhost/projects/product_view.php')

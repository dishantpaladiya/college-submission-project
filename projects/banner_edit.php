...
if (isset($_POST['details']) && isset($_POST['paragraph']) && isset($_POST['id']) && isset($_FILES['image'])) {
    ...
    if (move_uploaded_file($tmp_name, $path)) {
        // Update query
        $sql = "UPDATE `banner_data` SET `details`='$details',`paragraph`='$paragraph',`image`='$image' WHERE `id`=$id";
